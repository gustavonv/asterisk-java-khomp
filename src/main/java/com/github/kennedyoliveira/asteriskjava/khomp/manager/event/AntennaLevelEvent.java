...
import com.github.kennedyoliveira.asteriskjava.khomp.Constants;
  ...
  public float getSignalLevel() {
    if (this.signal != null && !this.signal.isEmpty()) {
      try {
        ...
        log.error("Parsing the antenna signal level: {}. Please report at {}", this.signal, Constants.ISSUE_LINK);
      }
    }
