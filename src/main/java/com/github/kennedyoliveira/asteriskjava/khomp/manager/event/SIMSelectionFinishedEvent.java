...
import com.github.kennedyoliveira.asteriskjava.khomp.manager.action.KSelectSIMCardAction;
import org.asteriskjava.manager.event.ManagerEvent;

/**
 * <p>Reports the successful or fail of a {@link KSelectSIMCardAction} or calling the same application by the dialplan extension.</p>
 *
 * @author kennedy
 * @since Driver 4.0
 */
